...
const Voucher = () => {
  ...
  const handleDelete = (_id) => {
    axios
      .delete(`/api/event_command/voucher/delete/${_id}`)
      .then((response) => {
  ...
  return (
    <div>
      ...
      <div className="wrapper d-flex flex-column min-vh-100">
        ...
        <div className="body flex-grow-1 m-4">
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <Link
              to="/vouchers/create"
              className="btn btn-success text-white no-wrap mx-2"
            >
              Create Voucher
            </Link>
          </div>
                    ...
                    <CCard className="shadow-sm card-hover">
                      ...
                      <CCardBody style={{ padding: "1rem" }}>
                        ...
                        >
                          ...
                          {moment(
                            new Date(
                              new Date(voucher.expTime) - 7 * 3600 * 1000,
                            ),
                          ).format("L") +
                            " " +
                            moment(
                        ...
                        <div className="d-flex justify-content-end">
                          <CButton
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              e.preventDefault();
                              openDeleteConfirmation(voucher);
                            }}
                          >
                            Delete
                          </CButton>
      ...
      <CModal visible={visible} onClose={() => setVisible(false)}>
        ...
        <CModalBody>
          {selectedVoucher?.eventID
            ? "This voucher is belonged to an event, are you sure you want to delete this voucher?"
