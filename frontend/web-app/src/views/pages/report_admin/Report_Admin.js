        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <CNav variant="tabs" className="mb-3">
              <CNavItem>
                <CNavLink href="/report" active>Brand</CNavLink>
              </CNavItem>
              <CNavItem>
                <CNavLink href="/report/users">User</CNavLink>
              </CNavItem>
              <CNavItem>
              ...
              <CRow>
                <CCol sm={6} md={3}>
                  <CCard className="text-center mb-4 custom-card">
                    <CCardHeader>Total Events Created</CCardHeader>
                    <CCardBody>
                ...
                <CCol sm={6} md={3}>
                  <CCard className="text-center mb-4 custom-card">
                    <CCardHeader>Total Vouchers Created</CCardHeader>
                    <CCardBody>
                ...
                <CCol sm={6} md={3}>
                  <CCard className="text-center mb-4 custom-card">
                    <CCardHeader>Total Vouchers Issued</CCardHeader>
                    <CCardBody>
                ...
                <CCol sm={6} md={3}>
                  <CCard className="text-center mb-4 custom-card">
                    <CCardHeader>Total Users Join</CCardHeader>
                    <CCardBody>
