...
const AddCusModal = ({ isVisible, onCancel, form, setSelectedRole }) => {
  ...
  const handleFormSubmit = async () => {
    if (!name || !email || !phonenum || !password || !facebookUrl || !gender) {
    ...
    try {
      const result = await request(
        "api/user-management/create/customer",
        "post",
        updatedUser,
      );
      ...
      >
        ...
        <CModalBody>
          ...
          >
            ...
            <CInputGroup className="mb-3">
              <CInputGroupText id="basic-addon-gender">
                <CIcon icon={cilUser} />
              </CInputGroupText>
              <CFormSelect
                aria-label="Gender"
            ...
            <CInputGroup className="mb-3">
              <CInputGroupText id="basic-addon-facebook-url">
