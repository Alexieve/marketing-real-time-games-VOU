...
const AddCusModal = ({ isVisible, onCancel, form }) => {
  ...
  const handleFormSubmit = async () => {
    if (!name || !email || !phone || !password || !facebookUrl || !gender) {
    ...
    >
      ...
      <CModalBody>
        <CForm form={form} onFinish={handleFormSubmit} layout="vertical" id="user-form">
          ...
          <CInputGroup className="mb-3">
            <CInputGroupText id="basic-addon-gender"><CIcon icon={cilUser} /></CInputGroupText>
            <CFormSelect
              aria-label="Gender"
              value={gender}
          ...
          <CInputGroup className="mb-3">
            <CInputGroupText id="basic-addon-facebook-url"><CIcon icon={cilAddressBook} /></CInputGroupText>
            <CFormInput 
              type="text" 
              placeholder="Facebook URL" 
              aria-label="Facebook URL" 
              aria-describedby="basic-addon-facebook-url"
              value={facebookUrl}
