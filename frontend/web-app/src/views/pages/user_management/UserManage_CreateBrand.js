...
const AddBrandModal = ({
  ...
  const handleFormSubmit = async () => {
    if (!name || !email || !phonenum || !password || !field || !address) {
    ...
    try {
      await request("api/user-management/create/brand", "post", updatedUser);
      ...
      >
        ...
        <CModalBody>
          ...
          >
            ...
            <CInputGroup className="mb-3">
              <CInputGroupText id="basic-addon-field">
                <CIcon icon={cilUser} />
              </CInputGroupText>
              <CFormInput
                name="field"
            ...
            <CInputGroup className="mb-3">
              <CInputGroupText id="basic-addon-address">
